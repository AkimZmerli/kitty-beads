...
// RunMolReadyGated runs the mol ready --gated command.
...
// registerReadyGatedCmd registers the ready gated command with the mol command
func registerReadyGatedCmd() {
